create table forex_all_day_aggs
(
    ticker varchar,
    volume bigint,
    open double,
...
with
(
    external_location ='s3a://polygon/unzipped/global_forex/day_aggs_v1/',
    format='PARQUET',
    partitioned_by=array['year', 'month', 'day'],
    partition_projection_enabled=true,
    partition_projection_location_template='s3a://polygon/unzipped/global_forex/day_aggs_v1/year=${year}/month=${month}/day=${day}'
);